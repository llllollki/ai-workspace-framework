# Active Tasks — alh-tracker

**Updated:** 2026-05-24

Quick-scan dashboard. For full detail, open each task file. This README is updated on each housekeeping pass.

---

## Status Dashboard

| Task | Blocker | Next required action | AI now? |
|---|---|---|---|
| [0001 — Business model and ALH relationship](0001-business-model-and-alh-relationship.md) | Owner | Run pricing probe (§6b) + support/onboarding assessment (§6d) with design partners — blocked on task 0002 outreach execution | Wait |
| [0002 — Design partner criteria and outreach](0002-design-partner-criteria-and-outreach.md) | Owner | Fill Section A (ALH CRM) → verify CCLD rows → send first warm outreach message → schedule site visit | Wait |
...
## Supporting Artifact (not a task)
...
**None.** All six active tasks are blocked on owner execution, counsel review, human TA confirmation, or future-phase gates. No AI/dev workstream can make further progress without external input.
